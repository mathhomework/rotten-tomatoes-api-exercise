...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Favorite.title'
        db.alter_column(u'tomatoes_favorite', 'title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Favorite.title'
        db.alter_column(u'tomatoes_favorite', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
